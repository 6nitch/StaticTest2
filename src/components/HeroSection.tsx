        ...
        <div className="flex flex-col gap-12 mt-16 mb-16">
          ...
          <div className="w-full">
            <div className="text-lg">
              <p>
                Web3 is driven by advanced technical innovation, enabling new business models and capital formation. For mass adoption, it must surpass current standards in <strong>security, privacy, interoperability, scalability, and usability</strong>. The next wave of financial services innovation lies in integrating Web3 protocols, AI, and infrastructure to meet evolving user demands. As traditional finance migrates into Web3, it requires robust systems for trading, custody, reporting, and user servicing—paving the way for financial services to evolve into decentralized, permissionless distribution channels.
              </p>
            </div>
          </div>
